...
<!--
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    DEPRECATED — OLD API PATTERN — DO NOT COPY THIS FILE
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

    This file uses the PRE-v2.0 API approach:
      - XSL variables selecting from $utilitiesAllDataSetAPIs
      - GetViewerAPIPath template calls
      - $.getJSON(apiUrl, callback) pattern

    ALL of these are OBSOLETE. Modern views use fetchAndRenderData(apiList)
    via core_api_fetcher.xsl.

    For a correct starting point, use:
      - essential-view://view-template   (api_fetch_template.xsl)
      - essential-view://quick-reference (golden pattern)
      - generate_view_scaffold tool

    This file is kept only as a historical reference for the legacy pattern.
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
-->
